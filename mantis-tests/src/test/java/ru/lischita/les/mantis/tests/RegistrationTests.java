...
public void startMailServer(){
  ...
  @Test
  public static void testRegistration() throws MessagingException, IOException {
  ...
  // List<MailMessage> mailMessages = app.mail().waitForMail(2, 60000);  // встроеный почтовый сервер
